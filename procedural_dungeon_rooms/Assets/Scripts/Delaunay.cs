...
namespace DelaunayVoronoi
{
    public class DelaunayTriangulator
    {
        ...
        public IEnumerable<Point> GeneratePoints(double maxX, double maxY, List<GameObject> finalrooms)
        {
            MaxX = maxX;
            MaxY = maxY;
           ...
           /* var random = new Random();
            ...
            {
                // Debug.Log(finalrooms.Count);
                // Debug.Log(i);
                points.Add(new Point(finalrooms[i].transform.position.x +MaxX/2, finalrooms[i].transform.position.y+maxY/2));
            }
